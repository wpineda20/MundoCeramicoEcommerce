                ...
                <v-container>
                    <v-row>
                        ...
                        <v-col cols="12" sm="12" md="3" lg="3" xl="3" class="d-flex align-items-center"
                            ...
                            <base-button type="primary" title="Agregar" style="background-color: #000C27;" @click="addRecord()" />
                        </v-col>
                    ...
                    <v-container>
                        ...
                        <v-row class="pt-3">
                            ...
                            <v-col cols="12" sm="6" md="6">
                                <base-input label="Longitud" v-model="v$.editedItem.location.longitude.$model"
                                    :rules="v$.editedItem.location.longitude" />
                            </v-col>
                            <!-- longitude -->
                            ...
                            <!-- latitude -->
                            <v-col cols="12" sm="6" md="6">
                                <base-input label="Latitud" v-model="v$.editedItem.location.latitude.$model"
                                    :rules="v$.editedItem.location.latitude" />
                            </v-col>
                            <!-- latitude -->
                            ...
                            <!-- address -->
                            <v-col cols="12" sm="12" md="12">
                                <base-input label="Dirección" v-model="v$.editedItem.address.$model"
    ...
    data() {
        return {
            ...
            headers: [
                ...
                // { title: "LONGITUD", key: "longitude" },
                // { title: "LATITUD", key: "latitude" },
    ...
    methods: {
        ...
        async save() {
            ...
            if (this.editedIndex > -1) {
                ...
                try {
                    const { data } = await backendApi.put(`store/${edited.id}`, edited);
            ...
            //Creating record
            try {
                const { data } = await backendApi.post(`/store`, this.editedItem);
        ...
        async deleteItemConfirm() {
            try {
                const { data } = await backendApi.delete(`/store/${this.editedItem.id}`, {
                    params: {
